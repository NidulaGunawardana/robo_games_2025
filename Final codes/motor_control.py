...
class RobotNavigator:
    ...
    def process_range_finder(self):
        ...
        image = self.camera_control.get_depth_and_rgb()
        depth_image = np.array(image[0])
    ...
    def process_camera(self, _depth_image):
        ...
        """
        cam_data = self.camera_control.get_depth_and_rgb()[1]
        if not cam_data:
            return
        ...
        cv2.imshow("Camera", cam_annotated_rgba)
